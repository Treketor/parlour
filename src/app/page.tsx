...
/*
 * No data layer yet (stage 3), so the library is always empty for now and
 * this is the state a new account sees.
 */
export default function LibraryPage() {
  return (
    <>
      <PageHeader title="Library" meta="No games yet" />
      ...
      <section className={styles.empty} aria-labelledby="empty-title">
        <div className={styles.start}>
          ...
          <p className={styles.emptyBody}>
            Search for it, pick the platform you play it on, and it lands here. Each platform gets
            its own entry, so the Switch and PC versions of a game can have different progress,
            ratings and notes.
          </p>
        ...
        <div className={styles.legend}>
          ...
          <p className={styles.legendNote}>
            Ratings are whole numbers from 1 to 10, or none at all. Anything else, like wanting to
            go back for 100%, is a tag.
          </p>
        </div>
      </section>
    </>
